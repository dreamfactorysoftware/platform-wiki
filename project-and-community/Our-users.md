...
| ![sb-logo] [sb-logo]       | [Simply Business] [simplybusiness-site] is the UK's largest business insurance broker, with over 200,000 customers. Over 90% of our customers find us through online channels while a large percentage complete their transaction offline. We are implementing the SnowPlow collector to allow us to build a rich set of web analytics data that we can connect with our internal transaction reporting. We will be using this to improve the user experience and improve the efficiency of our marketing campaigns. |
