...
:
	[
		...
		},
		{
			...
			"Resource": [
				"arn:aws:s3:::dreamfactory-saas-archive-eu-west-1/snplow2/events/*", "arn:aws:s3:::dreamfactory-saas-archive-eu-west-1/gforces/events/*"
			],
			"Effect":   "Allow"
		},
		{
		...
		},
		{
			...
			"Action":   [
				"s3:DeleteObject", "s3:DeleteObjectVersion", "s3:GetObject", "s3:GetObjectAcl", "s3:GetObjectVersion", "s3:GetObjectVersionAcl", "s3:PutObject",
