...
#### Calling the trackStructEvent method: asyncronous implementation
...
#### Calling the trackStructEvent method: syncronous implementation:

The sync specification for the `trackStructEvent` method is:
