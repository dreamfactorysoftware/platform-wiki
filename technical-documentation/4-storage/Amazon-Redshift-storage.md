...
Currently, Snowplow events are stored in Redshift in a single events table. The full table definition is given in the [Github repo][redshift-table-def]. It is reproduced below for convenience:
